      ...
      <div className="flex h-full w-80 flex-col justify-between bg-black p-8">
        <div className="flex w-full flex-col">
          <div className="flex w-full select-none flex-col items-center justify-center text-green">
            <h1 className=" w-full font-secondary text-5xl font-semibold">
              Meme
            </h1>
          ...
          <form className="mt-12 flex w-full select-none flex-col items-start">
            <input
              placeholder="search memes"
              className="mb-1 rounded bg-grey p-1 pl-2 text-xl text-white outline-none "
            />
          </form>
        </div>
